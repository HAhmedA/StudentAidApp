...
BEGIN
    ...
    VALUES ('a1b2c3d4-0001-7890-abcd-ef1234567890', 'high_achiever')
    ...
    INSERT INTO public.student_profiles (user_id, simulated_profile)
    VALUES ('a1b2c3d4-0002-7890-abcd-ef1234567890', 'average')
    ...
    INSERT INTO public.student_profiles (user_id, simulated_profile)
    VALUES ('a1b2c3d4-0003-7890-abcd-ef1234567890', 'low_achiever')
    ...
    INSERT INTO public.student_profiles (user_id, simulated_profile)
    VALUES ('a1b2c3d4-0004-7890-abcd-ef1234567890', 'high_achiever')
    ON CONFLICT (user_id) DO UPDATE SET simulated_profile = 'high_achiever';
    ...
    INSERT INTO public.student_profiles (user_id, simulated_profile)
    VALUES ('a1b2c3d4-0005-7890-abcd-ef1234567890', 'average')
    ON CONFLICT (user_id) DO UPDATE SET simulated_profile = 'average';
    ...
    INSERT INTO public.student_profiles (user_id, simulated_profile)
    VALUES ('a1b2c3d4-0006-7890-abcd-ef1234567890', 'low_achiever')
    ON CONFLICT (user_id) DO UPDATE SET simulated_profile = 'low_achiever';
    ...
    INSERT INTO public.student_profiles (user_id, simulated_profile)
    VALUES ('a1b2c3d4-0007-7890-abcd-ef1234567890', 'high_achiever')
    ON CONFLICT (user_id) DO UPDATE SET simulated_profile = 'high_achiever';
    ...
    INSERT INTO public.student_profiles (user_id, simulated_profile)
    VALUES ('a1b2c3d4-0008-7890-abcd-ef1234567890', 'average')
    ON CONFLICT (user_id) DO UPDATE SET simulated_profile = 'average';
    ...
    INSERT INTO public.student_profiles (user_id, simulated_profile)
    VALUES ('a1b2c3d4-0009-7890-abcd-ef1234567890', 'low_achiever')
    ON CONFLICT (user_id) DO UPDATE SET simulated_profile = 'low_achiever';
    ...
    INSERT INTO public.student_profiles (user_id, simulated_profile)
    VALUES ('a1b2c3d4-0010-7890-abcd-ef1234567890', 'high_achiever')
    ON CONFLICT (user_id) DO UPDATE SET simulated_profile = 'high_achiever';
    ...
    INSERT INTO public.student_profiles (user_id, simulated_profile)
    VALUES ('a1b2c3d4-0011-7890-abcd-ef1234567890', 'average')
    ON CONFLICT (user_id) DO UPDATE SET simulated_profile = 'average';
    ...
    INSERT INTO public.student_profiles (user_id, simulated_profile)
    VALUES ('a1b2c3d4-0012-7890-abcd-ef1234567890', 'low_achiever')
    ON CONFLICT (user_id) DO UPDATE SET simulated_profile = 'low_achiever';
    ...
    INSERT INTO public.student_profiles (user_id, simulated_profile)
    VALUES ('a1b2c3d4-0013-7890-abcd-ef1234567890', 'high_achiever')
    ON CONFLICT (user_id) DO UPDATE SET simulated_profile = 'high_achiever';
    ...
    INSERT INTO public.student_profiles (user_id, simulated_profile)
    VALUES ('a1b2c3d4-0014-7890-abcd-ef1234567890', 'average')
    ON CONFLICT (user_id) DO UPDATE SET simulated_profile = 'average';
    ...
    INSERT INTO public.student_profiles (user_id, simulated_profile)
    VALUES ('a1b2c3d4-0015-7890-abcd-ef1234567890', 'low_achiever')
    ON CONFLICT (user_id) DO UPDATE SET simulated_profile = 'low_achiever';
    ...
    INSERT INTO public.student_profiles (user_id, simulated_profile)
    VALUES ('a1b2c3d4-0016-7890-abcd-ef1234567890', 'high_achiever')
    ON CONFLICT (user_id) DO UPDATE SET simulated_profile = 'high_achiever';
    ...
    INSERT INTO public.student_profiles (user_id, simulated_profile)
    VALUES ('a1b2c3d4-0017-7890-abcd-ef1234567890', 'average')
    ON CONFLICT (user_id) DO UPDATE SET simulated_profile = 'average';
    ...
    INSERT INTO public.student_profiles (user_id, simulated_profile)
    VALUES ('a1b2c3d4-0018-7890-abcd-ef1234567890', 'low_achiever')
    ON CONFLICT (user_id) DO UPDATE SET simulated_profile = 'low_achiever';
    ...
    INSERT INTO public.student_profiles (user_id, simulated_profile)
    VALUES ('a1b2c3d4-0019-7890-abcd-ef1234567890', 'high_achiever')
    ON CONFLICT (user_id) DO UPDATE SET simulated_profile = 'high_achiever';
    ...
    INSERT INTO public.student_profiles (user_id, simulated_profile)
    VALUES ('a1b2c3d4-0020-7890-abcd-ef1234567890', 'average')
    ON CONFLICT (user_id) DO UPDATE SET simulated_profile = 'average';
